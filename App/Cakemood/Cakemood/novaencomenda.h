...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txt_dataentrega->TabIndex = 20;
			...
			this->txt_massabolo->TabIndex = 20;
			// 
			// label9
			// 
			...
			this->txt_recheiosuspiro->TabIndex = 20;
			// 
			// label11
			// 
			...
			this->txt_coberturarecheio->TabIndex = 20;
			...
			this->txt_cheesecake->TabIndex = 20;
			// 
			// label19
			// 
